...
def main():
    for EnvCls, kwargs in CONFIGS:
        print(f"\n=== Training DDQN + Replay on {EnvCls.__name__} ===")
        env = EnvCls()
        ddqn_replay(env, **kwargs)
